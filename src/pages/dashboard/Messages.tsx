...
import { Box, Button, TextField, Typography, Paper, IconButton, Avatar, Tooltip, CircularProgress, Badge } from '@mui/material';
...
const Messages = () => {
  ...
  const handleStartConversation = async () => {
    setLoading(true);
    try {
      const conversation = await chatApi.createConversation(1); // Admin/Support user ID
      await fetchConversations();
      setSelectedConversation(conversation);
    } catch (error) {
